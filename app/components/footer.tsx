    ...
    <footer className={className}>
      <div className="flex flex-row items-center justify-around">
        ...
        <nav className="flex flex-row gap-10">
          <Link href="/contato" className="text-gray-300 hover:text-gray-200">
            Fale conosco
          </Link>
          <Link href="/trocas" className="text-gray-300 hover:text-gray-200">
            Trocas / Devoluções
          </Link>
        ...
        <div className="flex flex-row gap-10">
          ...
          <Link href="https://www.instagram.com/vistajitsu">
            <button
              type="button"
              data-twe-ripple-init
              data-twe-ripple-color="light"
